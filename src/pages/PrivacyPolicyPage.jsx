...
const PrivacyPolicyPage = () => {
  return (
    ...
    flex flex-col gap-2"
    >
      <h4 className="text-[32px] text-white">Privacy Policy</h4>
      ...
      <Divider />
      <h2 className="text-white font-bold">Interpretation and Definitions</h2>
      <h3 className="text-white font-bold">Interpretation</h3>
      <p>
      ...
      <Divider />
      <h3 className="text-white font-bold">Definitions</h3>
      <p>For the purposes of this Privacy Policy:</p>
      <ul>
        <li>
          <p>
            <strong className="text-white font-bold">Account</strong> means a
        ...
        <li>
          <p>
            <strong className="text-white font-bold">Affiliate</strong> means an
        ...
        <li>
          <p>
            <strong className="text-white font-bold">Application</strong> refers
            to Movieverse, the software program provided by the Company.
          </p>
        </li>
        <li>
          <p>
            <strong className="text-white font-bold">Company</strong> (referred
            to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
            or &quot;Our&quot; in this Agreement) refers to Movieverse.
          </p>
        </li>
        <li>
          <p>
            <strong className="text-white font-bold">Country</strong> refers to:
            Iran
          </p>
        </li>
        <li>
          <p>
            <strong className="text-white font-bold">Device</strong> means any
        ...
        <li>
          <p>
            <strong className="text-white font-bold">Personal Data</strong> is
        ...
        <li>
          <p>
            <strong className="text-white font-bold">Service</strong> refers to
            the Application.
          </p>
        </li>
        <li>
          <p>
            <strong className="text-white font-bold">Service Provider</strong>{" "}
        ...
        <li>
          <p>
            <strong className="text-white font-bold">Usage Data</strong> refers
        ...
        <li>
          <p>
            <strong className="text-white font-bold">You</strong> means the
      ...
      <h3 className="text-white font-bold">Types of Data Collected</h3>
      <h4 className="text-white font-bold">Personal Data</h4>
      <p>
      ...
      <h4 className="text-white font-bold">Usage Data</h4>
      ...
      <Divider />
      <h3 className="text-white font-bold">Use of Your Personal Data</h3>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong className="text-white font-bold">To contact You:</strong> To
        ...
        <li>
          <p>
            <strong className="text-white font-bold">To provide You</strong>{" "}
        ...
        <li>
          <p>
            <strong className="text-white font-bold">For other purposes</strong>
      ...
      <ul>
        ...
        <li>
          <strong className="text-white font-bold">With Affiliates:</strong> We
        ...
        <li>
          <strong className="text-white font-bold">With other users:</strong>{" "}
        ...
        <li>
          <strong className="text-white font-bold">With Your consent</strong>:
          We may disclose Your personal information for any other purpose with
          Your consent.
        </li>
      </ul>
      <Divider />
      <h3 className="text-white font-bold">Retention of Your Personal Data</h3>
      <p>
      ...
      <Divider />
      <h3 className="text-white font-bold">Transfer of Your Personal Data</h3>
      <p>
      ...
      <Divider />
      <h3 className="text-white font-bold">Delete Your Personal Data</h3>
      <p>
      ...
      <Divider />
      <h3 className="text-white font-bold">Disclosure of Your Personal Data</h3>
      <h4 className="text-white font-bold">Business Transactions</h4>
      <p>
      ...
      <Divider />
      <h4 className="text-white font-bold">Law enforcement</h4>
      <p>
      ...
      <Divider />
      <h4 className="text-white font-bold">Other legal requirements</h4>
      <p>
      ...
      <Divider />
      <h3 className="text-white font-bold">Security of Your Personal Data</h3>
      <p>
      ...
      <Divider />
      <h2 className="text-white font-bold">Children's Privacy</h2>
      <p>
      ...
      <Divider />
      <h2 className="text-white font-bold">Links to Other Websites</h2>
      <p>
      ...
      <Divider />
      <h2 className="text-white font-bold">Changes to this Privacy Policy</h2>
      <p>
      ...
      <ul>
        <li>
          ...
          <a
            href="https://github.com/AslanReza"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://github.com/AslanReza
          </a>
        </li>
      </ul>
    </div>
